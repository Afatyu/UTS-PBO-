...
class Mahasiswa {
    ...
    void method2() {
        ...
        System.out.print("Usia: ");
        usia = keyboard.nextInt();
        System.out.println("\nHalo " + nama + " Selamat Datang di Perpustakaan UPB\n\n");
...
class BukuPsikologi {
    ...
    void method5() {
        ...
        System.out.println(
                "3. Bimbingan dan Konseling Belajar, 2001, Abdul Saman, Ph.D., Kons. dan Agustan Arifin M.Pd.");
        System.out
                .println("4. Psikologi Pedidikan, 1998, Mahsup, S,Pd., M.Pd dan Yunita Septriana Anwar, S.Pd., M.Sc.");
...
class BukuPolitik {
    ...
    void method6() {
        ...
        System.out.println(
                "6. Ada Apa dengan China: Esai-Esai Agama dan Politik China untuk Indonesia, 2019, Novi Basuki\n\n");
        Scanner keyboard = new Scanner(System.in);
        System.out.print("Masukan Nama Buku: ");
        masukan = keyboard.nextLine();
        System.out.println(masukan);
...
public class frans {
    public static void main(String[] args) {
        ...
        penutup salam = new penutup("Trimakasih Telah Berkunjung di Perpustakaan UPB, Sampai Jumpa Kembali");
